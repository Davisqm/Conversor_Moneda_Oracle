...
public class function {
    ...
    public void ConvertirMonedas(double Minput) {
    	String opcion = (JOptionPane.showInputDialog(null, 
    			...
    			{"De Pesos a Dólar", "De Pesos a Euro", "De Pesos a Libras","De Pesos a Yen","De Pesos a Won Coreano","De Dólar a Pesos", "De Euro a Pesos", "De Libras a Pesos","De Yen a Pesos","De Won Coreano a Pesos","De Rublos a Pesos"}, 
    			"Seleccion")).toString();
        switch(opcion) {
        ...
        case "De Rublos a pesos":
        	pesos.convertirRublosAPesos(Minput);
        	break;
        }   
    }
